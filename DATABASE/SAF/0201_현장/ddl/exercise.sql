...
-- 11. 아래와 같이 출력 되도록 Query 작성 => concat 사용
--       사번               업무        
--       101   The Job of Steven King is AD_PRES.
select empid, concat("The Job Of ", fname, lname, " is ", jobid)
from emp;
...
-- 14. 부서 ID가 40번이 아닌 부서에 속한 직원 들 중 SALARY가 20000
--     이상인 레코드
select *
from emp
where deptid != 40
...
select empid, phone, jobid, salary
from emp
