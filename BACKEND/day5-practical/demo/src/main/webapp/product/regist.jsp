...
<body>
	...
	<div class="container p-4">
	  ...
	  <h2>상품 정보 등록</h2>
	  <form id="registForm" action = "insertProcess" method="post">
	  	<input type="hidden" name="action" value="">
	    <div class="form-group">
	      <label for="productCode">고유번호</label>
	      <input type="text" class="form-control" id="productCode" placeholder="고유번호 입력" name="code">
	    </div>
	    <div class="form-group">
	      <label for="model">모델명</label>
	      <input type="text" class="form-control" id="model" placeholder="모델명 입력" name="model">
	    </div>
	    <div class="form-group">
